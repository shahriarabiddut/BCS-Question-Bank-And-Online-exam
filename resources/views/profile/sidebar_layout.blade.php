...
<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Books Services - Utilities Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link @if (!request()->is('user/exam*'))
            collapsed
        ...
        <div id="collapseTwo" class="collapse @if(request()->is('user/exam*')) show @endif" aria-labelledby="headingUtilities"
            data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Exam </h6>
                <a class="collapse-item" href="{{ route('user.exam.index') }}">View All</a>
            </div>
        </div>
    </li>
    <!-- Nav I
