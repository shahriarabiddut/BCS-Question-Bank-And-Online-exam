...
@section('title', 'Add Subject | Staff Dashboard')
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Add Subject Data
            <a href="{{ route('staff.subject.index') }}" class="float-right btn btn-success btn-sm"> <i class="fa fa-arrow-left"></i> View All </a> </h6>
        </div>
        <div class="card-body">
            
            <div class="table-responsive">
            <form method="POST" action="{{ route('staff.subject.store') }}" enctype="multipart/form-data">
                @csrf
