...
@section('title', 'Book Details | Staff Dashboard')
@section('content')
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered" width="100%">
                    ...
                    <tr>
                        <td colspan="2">
                            <a href="{{ route('staff.book.edit',$data->id) }}" class="float-right btn btn-info btn-sm"><i class="fa fa-edit"> Edit {{ $data->title }}  </i></a>
                        </td>
